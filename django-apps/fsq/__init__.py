...
License: BSD License (http://pypi.python.org/pypi/foursquare/0.1.1)
...
------------
from fsq import FoursquareApi as F
from django.conf import settings
u = settings.FOURSQUARE_USERNAME
p = settings.FOURSQUARE_PASSWORD
headers = {
...
class FoursquareApi():
    ...
    def get_pending_friends(self, username, password, **kwargs):
        """
            ...
            Response:
            {'requests': [{'firstname': 'kabir',
               'gender': 'none',
               'id': 23616,
               'lastname': 'hemrajani',
               'photo': 'http://playfoursquare.s3.amazonaws.com/userpix_thumbs/ZIV0EBREZFJF0YFH.jpg',
               'twitter': 'kabirh'},
              {'facebook': '9801369',
               'firstname': 'Kate',
               'gender': 'female',
               'id': 24644,
               'lastname': 'Gardiner',
               'photo': 'http://playfoursquare.s3.amazonaws.com/userpix_thumbs/4a70822cee910.jpg',
               'twitter': 'kategardiner'}]}
        """
        result = self._return_result('friend/requests', username=username, password=password, params=kwargs, post=False)        
        return result
    
    def approve_friend(self, username, password, uid, **kwargs):
        """
        ...
        """
        kwargs['uid'] = uid
        result = self._return_result('friend/approve', username=username, password=password, params=kwargs, post=True)        
        return result
