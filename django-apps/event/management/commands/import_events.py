...
_x = logging.getLogger('event.management.commands.import_events')
_TASK_LOCK_PORT = getattr(settings, 'TASK_LOCK_PORT', {})


class Command(BaseCommand):
    option_list = BaseCommand.option_list + (
        make_option('--hashtag', dest='hashtag', default='#SXSWm #Showcase'),
        ...
        make_option('--event_source', dest='event_source', default='sxsw'),
        make_option('--geoloc', dest='geoloc', default='30.27,-97.74'),
    )
    help = """Imports events from a spreadsheet"""
